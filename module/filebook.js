...
function checkUBookExist(req,res,next) {
...
function checkUBookExistence(req,res,next){
    let bookid=req.params.bookid;
    let userid=req.params.userid;
    var userbookExists= userBookArray.findIndex(item => item.bookid == bookid && item.id==userid);
...
module.exports={getUserBookData,addUserBook,checkUBookExist,checkUBookExistence,updateUserBook,deleteUserBook};