...
function checkfileUserExistence(req,res,next){
    let id=req.params.userid;
    var userExists= userdataArray.findIndex(item => item.id == id);
...
function getUData(req,res,next){
...
module.exports={getUData,addUserData,checkfileUserExist,updateUserData,checkfileUserExistence,deleteUserData}